	...
	document.querySelectorAll(".Web_MainControl_textbox").forEach(function (t) {
		...
		data: {
			...
			theEndCustomerEmailConfigForm: [
				...
				},
				{
					...
					label: 'Brødtekst til hjemmeside',
					type: 'textarea',
					value: '',
					validated: true
				},
				...
				{
					id: 'css',
					label: 'Custom CSS til hjemmesiden',
					type: 'textarea',
					value: '',
					validated: true
				}
		...
		computed: {
			...
			onpProductListFilters() {
				var e = [];
				return this.onpProductList.forEach(t => {
		...
		methods: {
			...
			setTypeOptionsInOnpForm(items, standardFormProp, formProp) {
				let values = [];
				const standardItems = [
					{ value: '001', title: 'Installationsydelse (001)' },
					{ value: '002', title: 'Skader / Reparation (002)' },
					{ value: '003', title: 'Uberettiget fejlretning (003)' }
				]
